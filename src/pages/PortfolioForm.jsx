  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className='flex flex-col gap-5 justify-center items-center h-screen'>
        ...
        {/* Using ...formData because going to next field, prev fields data doesnt gets lost */}
        ...
        <input placeholder='Portfolio URL [OPTIONAL]' value={formData['portfolio']} onChange={(e) => setFormData({...formData, portfolio:e.target.value})} type='text' id='portfolio' className='py-2 px-1 w-[300px] border' />
        <input placeholder='GitHub Profile URL' value={formData['github']} type='text' id='github' onChange={(e) => setFormData({...formData, github:e.target.value})} className='py-2 px-1 w-[300px] border' required />
        <input placeholder='Linedin Profile URL'  type='text' id='linkedin' value={formData['linkedin']} onChange={(e) => setFormData({...formData, linkedin:e.target.value})} className='py-2 px-1 w-[300px] border' required />
        <input placeholder='Image'  type='text' id='image' value={formData['image']} onChange={(e) => setFormData({...formData, image:e.target.value})} className='py-2 px-1 w-[300px] border' required />
